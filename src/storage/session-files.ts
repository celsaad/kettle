...
export function createSession(id: string, workout: string | null, startedAt: string): Session {
  const session: Session = { version: 1, id, workout, startedAt, endedAt: null, entries: [] };
