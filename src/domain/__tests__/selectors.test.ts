...
describe('nextWeekAfter', () => {
  ...
  it('returns a rest slot as the literal next one, without skipping it', () => {
    ...
    const sessions = [makeSession({ startedAt: 't', program: 'prog', programWeek: 1, programDay: 'Day 1' })];
...
describe('nextUpView and rest days', () => {
  ...
  const trainedOn = (date: Date, day = 'Day 1') => [
    makeSession({ startedAt: date.toISOString(), program: 'prog', programWeek: 1, programDay: day }),
  ];
