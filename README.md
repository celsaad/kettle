...
guide's prose is English-only by decision, not omission. The UI ships in English and Brazilian Portuguese (396 keys at parity), with dates,
...
request. The suite is 454 tests across 40 files covering the domain layer, the session runner, and
